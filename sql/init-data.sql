...
-- 用户数据 (密码都是 123456 的BCrypt加密)
INSERT INTO sys_user (id, username, password, real_name, gender, phone, dept_id, post) VALUES
(1, 'admin', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '系统管理员', 1, '13800000001', 4, '系统管理员'),
(2, 'doctor01', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '张医生', 1, '13800000002', 5, '主治医师'),
(3, 'doctor02', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '李医生', 2, '13800000003', 6, '副主任医师'),
(4, 'cashier01', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '王收费员', 2, '13800000004', 4, '收费员'),
(5, 'pharmacist01', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '赵药剂师', 1, '13800000005', 18, '药剂师'),
(6, 'registrar01', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '刘挂号员', 2, '13800000006', 4, '挂号员');
...
(2, 5, CURDATE(), 'AM', 30, 0, 'NORMAL'),
(2, 5, CURDATE(), 'PM', 30, 0, 'NORMAL'),
(3, 6, CURDATE(), 'AM', 20, 0, 'EXPERT'),
(3, 6, CURDATE(), 'PM', 20, 0, 'EXPERT'),
(2, 5, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'AM', 30, 0, 'NORMAL'),
(2, 5, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'PM', 30, 0, 'NORMAL'),
(3, 6, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'AM', 20, 0, 'EXPERT'),
(3, 6, DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'PM', 20, 0, 'EXPERT');
